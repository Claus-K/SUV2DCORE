...
namespace Cells
{
    public class KillerCellLogic : MonoBehaviour
    {
        ...
        private void Awake()
        {
            _white = new WhiteCell(10, 10, 2, 100)
            {
        ...
        {
            target.GetComponent<CombatComponentV2>().TakeDamage(target.CompareTag("CellDef") ? 1000 : _cbv2.Damage);
        }
