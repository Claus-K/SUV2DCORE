...
namespace Camera
{
    public class Movement : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            _currentSpeed = isMoving ? Mathf.Clamp(_currentSpeed + _acceleration * Time.deltaTime, baseSpeed, _maxSpeed) : Mathf.Clamp(_currentSpeed - _acceleration * Time.deltaTime, baseSpeed, _maxSpeed);
